 ...
 *
 */
public class IabHelperNonStatic {
...
//-------------------------------------------------------------------------------------------------
    ...
    public IabHelperNonStatic(Context ctx) {
        mContext = ctx;
     ...
     */
    public void dispose() {
        Log.d(TAG, "IabHelper was just disposed by " + mContext.getClass().getSimpleName());
        logDebug("Disposing.");
        mSetupDone = false;
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, List<String> oldSkus,
            int requestCode, OnIabPurchaseFinishedListener listener, String extraData) throws MyIllegalStateException {
        checkNotDisposed();
    ...
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreSkus) throws IabException, MyIllegalStateException {
    ...
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus,
            List<String> moreSubsSkus) throws IabException, MyIllegalStateException {
        checkNotDisposed();
     ...
     */
    void consume(Purchase itemInfo) throws IabException, MyIllegalStateException {
        checkNotDisposed();
     ...
     * @param listener The listener to notify when the consumption operation finishes.
     */
    public void consumeAsync(List<Purchase> purchases, OnConsumeMultiFinishedListener listener) throws MyIllegalStateException {
        checkNotDisposed();
        checkSetupDone("consume");
